...
function createSidebar() {
  ...
  sidebar.innerHTML = `
    <div style="background: linear-gradient(135deg, rgba(255, 182, 193, 0.3), rgba(173, 216, 230, 0.3), rgba(221, 160, 221, 0.3)); padding: 20px; backdrop-filter: blur(15px); position: relative; border-bottom: 2px solid rgba(255, 182, 193, 0.5);">
    ...
    <div style="padding: 20px;">
      ...
      <div class="section-card">
        ...
        <div style="display: grid; gap: 12px;">
          <button id="selectTableBtn" class="sidebar-button" style="background: linear-gradient(135deg, rgba(255, 182, 193, 0.8), rgba(173, 216, 230, 0.8)); color: #000000; font-size: 15px; padding: 14px; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.8);">
            ▢ Select Table Region
          </button>
          <button id="previewTableBtn" class="sidebar-button" style="background: linear-gradient(135deg, rgba(173, 216, 230, 0.8), rgba(221, 160, 221, 0.8)); color: #000000; border: 2px solid rgba(255, 182, 193, 0.5); font-size: 15px; padding: 14px; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.8);">
            ◉ Preview Selected Data
          </button>
          <button id="loadToSQLBtn" class="sidebar-button" style="background: linear-gradient(135deg, rgba(221, 160, 221, 0.8), rgba(255, 182, 193, 0.8)); color: #000000; font-size: 15px; padding: 14px; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.8);">
            ▶ Prepare for Queries
          </button>
        </div>
...
• Filter where Z > 100" style="width: 100%; height: 100px; margin-top: 16px; display: none; padding: 16px; font-size: 14px; border: 2px solid #e2e8f0; border-radius: 12px; font-family: inherit; resize: vertical; line-height: 1.5;"></textarea>
        ...
        <button id="executeNLQueryBtn" class="sidebar-button" style="background: linear-gradient(135deg, rgba(255, 182, 193, 0.8), rgba(173, 216, 230, 0.8)); color: #000000; display: none; margin-top: 12px; font-size: 15px; padding: 14px; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.8);">
          ▷ Execute Query
        </button>
        ...
        <div id="chartControls" style="margin-top: 16px; display: none;">
          <button id="generateChartBtn" class="sidebar-button" style="background: linear-gradient(135deg, rgba(173, 216, 230, 0.8), rgba(221, 160, 221, 0.8)); color: #000000; font-size: 15px; padding: 14px; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.8);">
      ...
      <div class="section-card">
        ...
        <button id="selectChartBtn" class="sidebar-button" style="background: linear-gradient(135deg, rgba(221, 160, 221, 0.8), rgba(255, 182, 193, 0.8)); color: #000000; font-size: 15px; padding: 14px; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.8);">
      ...
      <div class="section-card">
        ...
        <div style="display: flex; justify-content: center;">
          <button id="downloadCSVBtn" class="sidebar-button" style="background: linear-gradient(135deg, rgba(255, 182, 193, 0.8), rgba(173, 216, 230, 0.8)); color: #000000; font-size: 14px; padding: 12px; width: 120px; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.8);">
            ▤ CSV
          </button>
        </div>
